...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.PB_Trig_Cam, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.PB_Reset_LR_Wheel, 13, 0, 1, 6)
        ...
        self.gridLayout_4.addWidget(self.PB_Reset_SR_Wheel, 10, 0, 1, 6)
...
Small robot left parts produced: {self.SR_right_part_ctr.text()} '''
    ...
    def accumulated_part_count(self):
        ...
        acc_quantity = int(text[5]) +int(text[11]) + int(text[17]) + int(text[27])
        write_str = time_display + "" + str(acc_quantity)
