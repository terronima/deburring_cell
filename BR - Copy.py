...
R_F2_2 = [Global_R_F2_2_centre_j, Global_R_F2_2_Test, Global_R_F2_2_P1, Global_R_F2_2_P2, Global_R_F2_2_P3,
          Global_R_F2_2_P4, Global_R_F2_2_Backoff, 22]

R_F3 = [Global_R_F3_centre_j, Global_R_F3_P1, Global_R_F3_P2, Global_R_F3_P3, Global_R_F3_P4, Global_R_F3_P5,
        Global_R_F3_P6, Global_R_F3_Backoff]

R_F4 = [Global_R_F4_centre_j, Global_R_F4_P1, Global_R_F4_P2, Global_R_F4_P3, Global_R_F4_P4, Global_R_F4_P5,
        Global_R_F4_Backoff]

R_F5 = [Global_R_F5_centre_j, Global_R_F5_P1, Global_R_F5_P2, Global_R_F5_P3, Global_R_F5_P4, Global_R_F5_P5,
...
R_F7 = [Global_R_F7_centre_j, Global_R_F7_P1, Global_R_F7_P2, Global_R_F7_P3, Global_R_F7_P4, Global_R_F7_P5,
        Global_R_F7_P6, Global_R_F7_P7, Global_R_F7_Backoff]

R_F8 = [Global_R_F8_centre_j, Global_R_F8_P1, Global_R_F8_P2, Global_R_F8_P3, Global_R_F8_P4, Global_R_F8_P5,
...
def deburr_L(*Faces, ref_c):
    ...
    for m in Faces:
        ...
        amovel(backoff_pos, vel=lmove_vel, acc=safe_acc, ref=NEW_COORDINATE_SYS)
        #wait(0.5)
        release_force
    set_ref_coord(DR_BASE)
    NEW_COORDINATE_SYS_FLAG = 0
...
def deburr_R(*Faces, ref_c):
    ...
    for m in Faces:
        ...
        for i in range(2, len(R_Face) - 2):
            R_Face_point = trans(R_Face[i],[delta_x, delta_y, delta_z, 0, 0, 0], R_1_COORD_SYS, R_1_COORD_SYS)
            Face_points.append(R_Face_point)
        tp_log ("Face Points:" +str(Face_points))
        backoff_pos = trans(R_Face[len(R_Face) - 1], [delta_x, delta_y, delta_z, 0, 0, 0], R_1_COORD_SYS, R_1_COORD_SYS)
        tp_log("Backoff pos: " +str(backoff_pos))
        set_ref_coord(R_1_COORD_SYS)
        movesx(Face_points, vel=deburr_vel, acc=deburr_acc, ref=R_1_COORD_SYS)
        amovel(backoff_pos, vel=lmove_vel, acc=safe_acc, ref=R_1_COORD_SYS)
        mwait(0)
        tp_log("second a move")
        wait(0.5)
        release_force  
    NEW_COORDINATE_SYS_FLAG = 0
