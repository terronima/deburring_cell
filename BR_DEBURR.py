...
L_F1 = [Global_L_F1_P1, Global_L_F1_P2, Global_L_F1_P3]

L_F1_2 = [Global_L_F1_P5, Global_L_F1_P6, Global_L_F1_P7]

L_F2 = [Global_L_F2_P1, Global_L_F2_P2, Global_L_F2_P3]

L_F3 = [Global_L_F3_P1, Global_L_F3_P2, Global_L_F3_P3, Global_L_F3_P4]

L_F5 = [Global_L_F5_P1, Global_L_F5_P2, Global_L_F5_P3, Global_L_F5_P4]

L_F7 = [Global_L_F7_P1, Global_L_F7_P2, Global_L_F7_P3]

L_F8 = [Global_L_F8_P1, Global_L_F8_P2, Global_L_F8_P3]

L_F6 = [Global_L_F6_P1, Global_L_F6_P2, Global_L_F6_P3, Global_L_F6_P4]

L_F4 = [Global_L_F4_P1, Global_L_F4_P2, Global_L_F4_P3, Global_L_F4_P4]

# List of point for R Part faces
R_F1 = [Global_R_F1_P1, Global_R_F1_P2, Global_R_F1_P3, Global_R_F1_P4, Global_R_F1_P5, Global_R_F1_P6]

R_F2 = [Global_R_F2_P1, Global_R_F2_P2, Global_R_F2_P3, Global_R_F2_P4, Global_R_F2_P5]

R_F3 = [Global_R_F3_P1, Global_R_F3_P2, Global_R_F3_P3, Global_R_F3_P4, Global_R_F3_P5, Global_R_F3_P6]

R_F5 = [Global_R_F5_P1, Global_R_F5_P2, Global_R_F5_P3, Global_R_F5_P4, Global_R_F5_P5, Global_R_F5_P6]
...
R_F6 = [Global_R_F6_P1, Global_R_F6_P2, Global_R_F6_P3, Global_R_F6_P4, Global_R_F6_P5, Global_R_F6_P6]

R_F4 = [Global_R_F4_P1, Global_R_F4_P2, Global_R_F4_P3, Global_R_F4_P4]
...
def L_F1_deburr(L_F1, ref_c, delta_x, delta_y, delta_z):
    ...
    movec(L_F1_points[1], L_F1_points[2], vel=deburr_vel, acc=deburr_acc)
    movel(Global_L_F1_P4, vel=deburr_vel, acc=deburr_acc)
    mwait(0)

def L_F1_2_deburr(L_F1_2, ref_c, delta_x, delta_y, delta_z):
    delta_x = delta_x + 7
    delta_z = delta_z - 7
    L_F1_2_points = []
    movej(Global_L_F1_REORIENT_J, vel=jmove_vel, acc=safe_acc)
    for i in range(0, len(L_F1_2)):
            L_Face_point = trans(L_F1_2[i],[delta_x, delta_y, delta_z, 0, 0, 0], ref_c, ref_c)
            L_F1_2_points.append(L_Face_point)
    movel(L_F1_2_points[0], vel=lmove_vel, acc=safe_acc)
    movec(L_F1_2_points[1], L_F1_2_points[2], vel=deburr_vel, acc=deburr_acc)
    movel(Global_L_F1_Backoff, vel=deburr_vel, acc=deburr_acc)
    mwait(0)
...
def L_F2_deburr(L_F2, ref_c, delta_x, delta_y, delta_z):
    ...
    movec(L_F2_points[1], L_F2_points[2], vel=deburr_vel, acc=deburr_acc)
...
def L_F3_deburr(L_F3, ref_c, delta_x, delta_y, delta_z):
    ...
    movel(L_F3_points[1], vel=lmove_vel, acc=safe_acc)
    movec(L_F3_points[2], L_F3_points[3], vel=deburr_vel, acc=deburr_acc)
...
def L_F5_deburr(L_F5, ref_c, delta_x, delta_y, delta_z):
    ...
    movel(L_F5_points[1], vel=lmove_vel, acc=safe_acc)
    movec(L_F5_points[2], L_F5_points[3], vel=deburr_vel, acc=deburr_acc)
...
def L_F6_deburr(L_F6, ref_c, delta_x, delta_y, delta_z):
    ...
    movel(L_F6_points[1], vel=lmove_vel, acc=safe_acc)
    movec(L_F6_points[2], L_F6_points[3], vel=deburr_vel, acc=deburr_acc)
...
def L_F4_deburr(L_F4, ref_c, delta_x, delta_y, delta_z):
    ...
    movel(L_F4_points[1], vel=lmove_vel, acc=safe_acc)
    movec(L_F4_points[2], L_F4_points[3], vel=deburr_vel, acc=deburr_acc)
...
def deburr_L_B1(ref_c):
    ...
    L_F7_deburr(L_F7, ref_c, delta_x, delta_y, delta_z)
...
def deburr_L_B2(ref_c):
    ...
    L_F1_2_deburr(L_F1_2, ref_c, delta_x, delta_y, delta_z)
    L_F2_deburr(L_F2, ref_c, delta_x, delta_y, delta_z)
    L_F8_deburr(L_F8, ref_c, delta_x, delta_y, delta_z)
    wait(0.5)
...
def R_F1_deburr(R_F1, ref_c, delta_x, delta_y, delta_z):
    ...
    movel(R_F1_points[1], vel=lmove_vel, acc=safe_acc, r=	75, ra=DR_MV_RA_DUPLICATE)
    movel(R_F1_points[2], vel=lmove_vel, acc=safe_acc)
    ...
    movel(R_F1_points[2], vel=lmove_vel, acc=safe_acc)
    movel(R_F1_points[4], vel=lmove_vel, acc=safe_acc, r=75, ra=DR_MV_RA_DUPLICATE)
    movel(R_F1_points[5], vel=lmove_vel, acc=safe_acc)
...
def R_F3_deburr(R_F3, ref_c, delta_x, delta_y, delta_z):
    ...
    for i in range(0, len(R_F3)):
            R_Face_point = trans(R_F3[i],[delta_x, delta_y, delta_z, 0, 0, 0], ref_c, ref_c)
            R_F3_points.append(R_Face_point)
    movel(R_F3_points[0], vel=lmove_vel, acc=safe_acc)
    amovel(R_F3_points[1], vel=lmove_vel, acc=safe_acc)
    movel(R_F3_points[2], vel=lmove_vel, acc=safe_acc, r=200, ra=DR_MV_RA_DUPLICATE)
    movel(R_F3_points[3], vel=lmove_vel, acc=safe_acc, r=200, ra=DR_MV_RA_DUPLICATE)
    movel(R_F3_points[4], vel=lmove_vel, acc=safe_acc, r=200, ra=DR_MV_RA_DUPLICATE)
    movel(R_F3_points[5], vel=lmove_vel, acc=safe_acc)
...
def R_F5_deburr(R_F5, ref_c, delta_x, delta_y, delta_z): 
    ...
    for i in range(0, len(R_F5)):
            R_Face_point = trans(R_F5[i],[delta_x, delta_y, delta_z, 0, 0, 0], ref_c, ref_c)
            R_F5_points.append(R_Face_point)
    movel(R_F5_points[0], vel=lmove_vel, acc=safe_acc)
    amovel(R_F5_points[1], vel=lmove_vel, acc=safe_acc)
    movel(R_F5_points[2], vel=lmove_vel, acc=safe_acc, r=200, ra=DR_MV_RA_DUPLICATE)
    movel(R_F5_points[3], vel=lmove_vel, acc=safe_acc, r=200, ra=DR_MV_RA_DUPLICATE)
    movel(R_F5_points[4], vel=lmove_vel, acc=safe_acc, r=200, ra=DR_MV_RA_DUPLICATE)
    movel(R_F5_points[5], vel=lmove_vel, acc=safe_acc)
...
def R_F6_deburr(R_F6, ref_c, delta_x, delta_y, delta_z):
    ...
    amovel(R_F6_points[1], vel=lmove_vel, acc=safe_acc)
    movel(R_F6_points[2], vel=lmove_vel, acc=safe_acc, r=200, ra=DR_MV_RA_DUPLICATE)
    movel(R_F6_points[3], vel=lmove_vel, acc=safe_acc, r=200, ra=DR_MV_RA_DUPLICATE)
    movel(R_F6_points[4], vel=lmove_vel, acc=safe_acc, r=200, ra=DR_MV_RA_DUPLICATE)
    movel(R_F6_points[5], vel=lmove_vel, acc=safe_acc)
...
def deburr_R_B1(ref_c):
    ...
    R_F7_deburr(R_F7, ref_c, delta_x, delta_y, delta_z)
    wait(0.5)
    set_digital_output(RIGHT_MOTOR, 0)
    set_digital_output(LEFT_MOTOR, 0)
...
def deburr_R_B2(ref_c):
    ...
    R_F8_deburr(R_F8, ref_c, delta_x, delta_y, delta_z)
    wait(0.5)
    set_digital_output(RIGHT_MOTOR, 0)
    set_digital_output(LEFT_MOTOR, 0)
