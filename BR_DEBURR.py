...
L_F2 = [Global_L_F2_P1, Global_L_F2_P2, Global_L_F2_P3, Global_L_F2_P4, Global_L_F2_P5, Global_L_F2_P6, Global_L_F2_P7,
        Global_L_F2_P8]

L_F3 = [Global_L_F3_P1, Global_L_F3_P2, Global_L_F3_P3, Global_L_F3_P4, Global_L_F3_P5, Global_L_F3_P6, Global_L_F3_P7,
        Global_L_F3_P8]

L_F5 = [Global_L_F5_P1, Global_L_F5_P2, Global_L_F5_P3, Global_L_F5_P4, Global_L_F5_P5, Global_L_F5_P6, Global_L_F5_P7,
        Global_L_F5_P8]
...
L_F6 = [Global_L_F6_P1, Global_L_F6_P2, Global_L_F6_P3, Global_L_F6_P4, Global_L_F6_P5, Global_L_F6_P6, Global_L_F6_P7,
        Global_L_F6_P8]

L_F4 = [Global_L_F4_P1, Global_L_F4_P2, Global_L_F4_P3, Global_L_F4_P4, Global_L_F4_P5, Global_L_F4_P6, Global_L_F4_P7,
        Global_L_F4_P8]
...
R_F2 = [Global_R_F2_P1, Global_R_F2_P2, Global_R_F2_P3, Global_R_F2_P4, Global_R_F2_P5, Global_R_F2_P6, Global_R_F2_P7,
        Global_R_F2_P8]

R_F3 = [Global_R_F3_P1, Global_R_F3_P2, Global_R_F3_P3, Global_R_F3_P4, Global_R_F3_P5, Global_R_F3_P6, Global_R_F3_P7,
        Global_R_F3_P8]

R_F5 = [Global_R_F5_P1, Global_R_F5_P2, Global_R_F5_P3, Global_R_F5_P4, Global_R_F5_P5, Global_R_F5_P6, Global_R_F5_P7,
        Global_R_F5_P8, Global_R_F5_P9]

R_F7 = [Global_R_F7_P1, Global_R_F7_P2, Global_R_F7_P3, Global_R_F7_P4, Global_R_F7_P5, Global_R_F7_P6, Global_R_F7_P7,
        Global_R_F7_P8]

R_F6 = [Global_R_F6_P1, Global_R_F6_P2, Global_R_F6_P3, Global_R_F6_P4, Global_R_F6_P5, Global_R_F6_P6, Global_R_F6_P7,
        Global_R_F6_P8, Global_R_F6_P9]

R_F4 = [Global_R_F4_P1, Global_R_F4_P2, Global_R_F4_P3, Global_R_F4_P4, Global_R_F4_P5, Global_R_F4_P6, Global_R_F4_P7,
        Global_R_F4_P8, Global_R_F4_P9]
...
def touch(ref_c, point_j, point_l):
    amovej(point_j, vel=jmove_vel, acc=safe_acc)
    mwait(0)
    set_ref_coord(ref_c)
    movel(point_l, vel=lmove_vel, acc=safe_acc)
    ...
    movej(point_j, vel=jmove_vel, acc=safe_acc)
    delta = subtract_pose(new_centre_position, point_l)
    return delta
...
def pick(pos):
    ...
    delta_y = None
    ref_c = None
    j_pos_list = [(Global_pick_L_0_above_j, Global_pick_L_0_j), (Global_pick_L_1_above_j, Global_pick_L_1_j),
                  (Global_pick_L_2_above_j, Global_pick_L_2_j)]
...
def L_F1_deburr(L_F1, ref_c, delta_x, delta_y, delta_z):
    ...
    movesx([L_F1_points[1], L_F1_points[2], L_F1_points[3], L_F1_points[4], L_F1_points[5], L_F1_points[6]],
           vel=deburr_vel, acc=deburr_acc)
...
def L_F2_deburr(L_F2, ref_c, delta_x, delta_y, delta_z):
    ...
    movesx([L_F2_points[1], L_F2_points[2], L_F2_points[3], L_F2_points[4], L_F2_points[5], L_F2_points[6],
            L_F2_points[7]], vel=deburr_vel, acc=deburr_acc)
...
def L_F3_deburr(L_F3, ref_c, delta_x, delta_y, delta_z):
    ...
    movesx([L_F3_points[1], L_F3_points[2], L_F3_points[3], L_F3_points[4], L_F3_points[5], L_F3_points[6],
            L_F3_points[7]], vel=deburr_vel, acc=deburr_acc)
...
def L_F5_deburr(L_F5, ref_c, delta_x, delta_y, delta_z):
    ...
    movesx([L_F5_points[1], L_F5_points[2], L_F5_points[3], L_F5_points[4], L_F5_points[5], L_F5_points[6],
            L_F5_points[7]], vel=deburr_vel, acc=deburr_acc)
...
def L_F7_deburr(L_F7, ref_c, delta_x, delta_y, delta_z):
    ...
    movesx([L_F7_points[0], L_F7_points[1], L_F7_points[2]], vel=deburr_vel, acc=deburr_acc)
...
def L_F8_deburr(L_F8, ref_c, delta_x, delta_y, delta_z):
    ...
    movesx([L_F8_points[0], L_F8_points[1], L_F8_points[2]], vel=deburr_vel, acc=deburr_acc)
...
def L_F6_deburr(L_F6, ref_c, delta_x, delta_y, delta_z):
    ...
    movesx([L_F6_points[1], L_F6_points[2], L_F6_points[3], L_F6_points[4], L_F6_points[5], L_F6_points[6],
            L_F6_points[7]], vel=deburr_vel, acc=deburr_acc)
...
def L_F4_deburr(L_F4, ref_c, delta_x, delta_y, delta_z):
    ...
    movesx([L_F4_points[1], L_F4_points[2], L_F4_points[3], L_F4_points[4], L_F4_points[5], L_F4_points[6],
            L_F4_points[7]], vel=deburr_vel, acc=deburr_acc)
...
def R_F1_deburr(R_F1, ref_c, delta_x, delta_y, delta_z):
    ...
    movesx(
        [R_F1_points[0], R_F1_points[1], R_F1_points[2], R_F1_points[3], R_F1_points[4], R_F1_points[5], R_F1_points[6],
         R_F1_points[7]], vel=deburr_vel, acc=deburr_acc)
...
def R_F7_deburr(R_F7, ref_c, delta_x, delta_y, delta_z):
    ...
    movesx([R_F7_points[1], R_F7_points[2], R_F7_points[3], R_F7_points[4], R_F7_points[5]], vel=deburr_vel,
           acc=deburr_acc)
...
def R_F6_deburr(R_F6, ref_c, delta_x, delta_y, delta_z):
    ...
    movesx(
        [R_F6_points[1], R_F6_points[2], R_F6_points[3], R_F6_points[4], R_F6_points[5], R_F6_points[6], R_F6_points[7],
         R_F6_points[8]], vel=lmove_vel, acc=safe_acc)
...
def R_F4_deburr(R_F4, ref_c, delta_x, delta_y, delta_z):
    ...
    movesx(
        [R_F4_points[1], R_F4_points[2], R_F4_points[3], R_F4_points[4], R_F4_points[5], R_F4_points[6], R_F4_points[7],
         R_F4_points[8], ], vel=lmove_vel, acc=safe_acc)
...
def R_F8_deburr(R_F8, ref_c, delta_x, delta_y, delta_z):
    ...
    movesx([R_F8_points[0], R_F8_points[1], R_F8_points[2], R_F8_points[3], R_F8_points[4]], vel=lmove_vel,
           acc=safe_acc)
